 ...
 */
fun Modifier.clickWithAnalytics(
    identifier: String,
    pageId: String? = null,
    params: Map<String, String?>? = null,
...
fun Modifier.longClickWithAnalytics(
    identifier: String,
    pageId: String? = null,
    params: Map<String, String?>? = null,
 ...
 */
fun Modifier.listItemClickWithAnalytics(
    identifier: String,
    index: Int,
    pageId: String,
