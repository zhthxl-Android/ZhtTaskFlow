...
/**
 * Release 风格可观测事件落盘（Debug 面板切换 [com.example.zhttaskflow.core.debug.TaskFlowDeveloperTools.ObservabilityBackend.RELEASE_LOCAL] 时使用）。
 *
 * 字段与 `app` 模块 [com.example.zhttaskflow.observability.ReleaseTaskFlowObservabilityContract] 对齐，避免 feature 依赖 app。
 */
internal object TaskFlowLocalObservabilityEmitter {
