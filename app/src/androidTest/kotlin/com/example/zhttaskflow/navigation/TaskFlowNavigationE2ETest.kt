...
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.LOGIN_DIALOG_TITLE
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.LOGIN_DISMISS
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.TAB_ARTICLE
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.TAB_LOG
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.TAB_TASK
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.TASK_DETAIL_TITLE
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.TASK_LIST_TITLE
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.DEMO_TASK_TITLE
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.articleDetailDeepLinkTarget
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.completeRouteGatesIfShown
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.isTextOnScreen
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.launchDeepLink
import com.example.zhttaskflow.androidtest.TaskFlowE2ETestSupport.pressSystemBack
...
class TaskFlowNavigationE2ETest {
    ...
    fun mainTabs_switchArticleTaskLog() {
        ...
        composeRule.waitForText(TaskFlowE2ETestSupport.LOG_VIEWER_TITLE)
    ...
    fun loginRequiredRoute_cancelLogin_staysOnTaskList() {
        ...
        composeRule.waitForText(DEMO_TASK_TITLE)
        composeRule.onNodeWithText(DEMO_TASK_TITLE, useUnmergedTree = true).performClick()
        composeRule.waitUntil(TaskFlowE2ETestSupport.DEFAULT_WAIT_MS) {
            composeRule.isTextOnScreen(LOGIN_DIALOG_TITLE) ||
                composeRule.isTextOnScreen(TaskFlowE2ETestSupport.PERMISSION_DIALOG_TITLE)
        }
        if (composeRule.isTextOnScreen(TaskFlowE2ETestSupport.PERMISSION_DIALOG_TITLE)) {
            composeRule.onNodeWithText(TaskFlowE2ETestSupport.PERMISSION_CONFIRM, useUnmergedTree = true)
                .performClick()
            composeRule.waitForText(LOGIN_DIALOG_TITLE)
        }
    ...
    fun deepLink_taskDetail_showsLoginGateThenDetail() {
        ...
        composeRule.launchDeepLink(
            com.example.zhttaskflow.nav.route.TaskFlowTaskNavRoutes.detailPath("demo-1"),
        )
        composeRule.waitForText(LOGIN_DIALOG_TITLE)
        composeRule.completeRouteGatesIfShown()
        composeRule.waitForText(TASK_DETAIL_TITLE)
